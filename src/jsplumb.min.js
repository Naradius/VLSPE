        ...
        var a = this,
            ...
            E = function(a, b, c, d) {
                ...
                this.downListener = function(a) {
                    ...
                    if (b && this.isEnabled() && this.canDrag()) {
                        ...
                        if (d) {
                            ...
                            if (x)
                                if (v = K.cloneNode(!0), this.params.addClass(v, q.clonedDrag), v.setAttribute("id", null), v.style.position = "absolute", null != this.params.parent) {
                ...
                var Z = function(a, b) {
                    var c = null;
                    if (Y[a])
                        for (var d = 0; d < Y[a].length; d++) try {
                            var e = Y[a][d](b);
                            null != e && (c = e)
                        } catch (f) {}
                    return c
